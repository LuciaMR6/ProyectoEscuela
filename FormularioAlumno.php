  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="FormularioAlumno.php">Alumnos <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="FormularioProfesor.php">Profesores</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php">Inscripción <span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
